...
require_once CAMPUS_CORE_PATH . 'includes/documents.php';      // LOT 5
...
require_once CAMPUS_CORE_PATH . 'includes/api-documents.php';  // LOT 5
...
require_once CAMPUS_CORE_PATH . 'includes/menu.php';           // LOT 6
